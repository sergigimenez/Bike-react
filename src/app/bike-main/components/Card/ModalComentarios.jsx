                ...
                >
                  ...
                  <div>
                    <Button
                      size="small"
                      variant="elevated"
                      sx={{ backgroundColor: secondary, mr: 1 }}
            ...
            {typeModal == "viewComment" && (
              <div className="container">
                {comentarios.toReversed().map((comentario) => {
                  const { userComent, dateComent, textComent, id, uid } =
                    comentario;
                    ...
                    >
                      <div className="col-sm-6 col-md-5 d-flex">
                        ...
                        <Typography variant="subtitle2">
                          {typeof userComent == "undefined" ? "" : userComent}
                        </Typography>
                      </div>
                      <div className="col-sm-6 offset-md-4 col-md-3 d-flex justify-content-end">
                        <Typography variant="caption">
                          {typeof dateComent == "undefined"
                            ? ""
                            : new Date(dateComent).toLocaleDateString()}
                        </Typography>
                      </div>
                      <div className="d-flex justify-content-between align-items-center">
                        <Typography variant="body2">
                          {typeof textComent == "undefined" ? "" : textComent}{" "}
                        </Typography>
                        <div>
                          ...
                          <IconButton
                            sx={{ color: "black", display: isVisible }}
                            onClick={() => {
