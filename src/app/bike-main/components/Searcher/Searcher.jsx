    ...
    <>
      <div className="row" style={{ marginTop: 10 }}>
        <div className="row">
          ...
          >
            <div
              className="col-8 d-flex align-items-center flex-flow-column"
            ...
            >
              ...
              >
                <Typography style={{ display: "flex", alignItems: "center" }}>
                  {fieldDistancia[0] != null
                    ? fieldDistancia[0] + " km"
                    : "0 km"}
                </Typography>
                <Typography style={{ display: "flex", alignItems: "center" }}>
                  {fieldDistancia[1] != null
                    ? fieldDistancia[1] + " km"
                    : "150 km"}
                </Typography>
              </div>
            ...
            >
              <FormControlLabel
                ...
                style={{ fontSize: "13px !important", margin: 0 }}
          ...
          >
            ...
            >
              ...
              >
                <Typography style={{ display: "flex", alignItems: "center" }}>
                  {fieldDesnivel[0] != null
                    ? fieldDesnivel[0] + " m +"
                    : "0 m +"}
                </Typography>
                <Typography style={{ display: "flex", alignItems: "center" }}>
                  {fieldDesnivel[1] != null
                    ? fieldDesnivel[1] + " m +"
                    : "3000 m +"}
                </Typography>
              </div>
      ...
      <div className="d-flex align-items-center">
        <p style={{ margin: 0, fontSize: 13 }}>
          Total Resultados: ({routes.totalResults})
        </p>
      </div>
    </>
  );
