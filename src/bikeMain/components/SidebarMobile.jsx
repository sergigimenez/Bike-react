...
import { InputAdornment, List, ListItem, ListItemButton, ListItemIcon, ListItemText, SwipeableDrawer, TextField } from "@mui/material";
...
export const SidebarMobile = ({ stateMenu, theme, menuItems }) => {
    ...
    return (
        ...
        >
            <Box sx={{ width: "100vw", height: '100%', backgroundColor: secondary }} role="presentation" >
                <TextField
                    hiddenLabel
                    variant="filled"
                    size="small"
