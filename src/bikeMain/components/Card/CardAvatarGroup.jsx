...
export const CardAvatarGroup = ({ stateComents, mediaQuery, isVisible, cardStyleMobile, onLike, cardLiked, id }) => {
            ...
            <div className='container'>
                <div className='row'>
                    <div className='col-xs-12 col-sm-12 col-md-8 d-flex justify-content-start' style={{visibility: 'visible'}}>
                        ...
                        <Typography variant='caption' sx={{ display: 'flex', alignItems: 'end', margin: "0 2px" }}>{stateComents.likes + " likes - " + stateComents.comentarios + " comentarios"}</Typography>
                    </div>
                    {
